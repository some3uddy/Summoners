...
class ScarabEntity(type: EntityType<out ScarabEntity>, world: World) : TameableEntity(type, world), IAngerable {
    ...
    companion object {
        ...
        private val ANGER_TIME: DataParameter<Int> = EntityDataManager.createKey(ScarabEntity::class.java, DataSerializers.VARINT)
    }
